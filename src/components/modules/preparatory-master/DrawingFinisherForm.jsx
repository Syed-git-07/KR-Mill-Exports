...
// ProdnMixing, Speed, Prodn Effi., Installed Date, IsActive, 
// Direct Hank Entry, Direct Kgs Entry
// NOTE: Same as Drawing Breaker - NO mc_effi field
...
export default function DrawingFinisherForm({ initialData, onSubmit, isLoading }) {
  const form = useForm({
