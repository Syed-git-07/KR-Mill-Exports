...
export async function lookupCardingMachineByNo(machineNo) {
  ...
  return {
    ...machine,
    speed_setup: machine.speed != null ? Number(machine.speed) : null,
    hank_constant: machine.hank_constant != null ? Number(machine.hank_constant) : null,
