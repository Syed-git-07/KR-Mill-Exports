...
const modules = [
  {
    title: "Masters",
    description:
      "Manage departments, machines, supervisors, and configurations",
    href: "/masters",
    icon: Settings,
  },
  {
    ...
    description:
      "Carding, Drawing, Comber, Simplex and other preparatory machine masters",
    href: "/preparatory-master",
    icon: Factory,
  },
  {
    title: "Preparatory Entry",
    description: "Daily production entry for all preparatory machines",
  ...
  },
  {
    ...
    description:
      "Daily production entry for Spinning, Autoconer, and post-preparatory machines",
  ...
  },
  {
    title: "Holiday List",
    description:
      "Manage the global production calendar and block entries on declared holidays",
    href: "/holiday-list",
    icon: CalendarDays,
  },
];
